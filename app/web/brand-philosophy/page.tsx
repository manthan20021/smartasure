...
<div
    ...
    >
                    ...
                    <div className="absolute right-0 top-0 bottom-0 w-full bg-gradient-to-t from-black via-50% to-transparent  pointer-events-none"></div>
...
<div>
      {/* PARAGRAPH + CTA */}
      <div
        className="mt-10 w-[200px] py-3.5 h-[400px] "
      >
        <p className="leading-4 text-[#2b2b2b] text-sm   ">
          <span className="font-semibold">At SmartaSure,</span> we believe true
          luxury lies in effortlessness.
          <br /><br />
          No clutter. No complexity. No compromise.
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <button className=" relative border-[#3F3F3F] z-10 text-[13px] sm:text-[15px] text-[#B4C9C9] bg-black mt-5 px-6 py-4 rounded-full">
            BOOK A PRIVATE DEMO
          </button>
        </a>
      </div>
